<div class="wrap">
	...
	echo sprintf( __('The currently working framework version is %s.', 'woocommerce-for-japan'), JP4WC_FRAMEWORK_VERSION );
	?><br />
	</p>
	<p>
	<?php echo __('Nice to meet you on Facebook page!', 'woocommerce-for-japan');?><br />
	<a href="https://www.facebook.com/wcjapan" target="_blank"><?php echo __('Japanized for WooCommerce Facebook page!', 'woocommerce-for-japan');?></a>
	</p>
</div>
