...
?>
<div>
    <h4 style="padding-left: 3%;"><?php _e('Catalog mode options:','elex-catmode-rolebased-price');?></h4>
    <h4 style="padding-left: 3%;font-style: italic;font-weight:normal;"><?php _e('The changes you make here will be applicable across user roles. You can exclude Administrator role from these settings. Catalog Mode Settings will override Role Based & Unregistered User Settings.','elex-catmode-rolebased-price');?></h4>
    ...
    <?php $checked = (( get_post_meta($post->ID, 'product_adjustment_hide_addtocart_catalog', true) ) == 'yes' ) ? true : false; ?>
...
<div style="padding-left: 3%;height: 60px;" id="shop_product_checkbox_prod_hide_addtocart_catalog">
    <?php $checked_shop_catalog = (( get_post_meta($post->ID, 'product_adjustment_hide_addtocart_catalog_shop', true) ) == 'yes' ) ? true : false;
    $checked_product_catalog = (( get_post_meta($post->ID, 'product_adjustment_hide_addtocart_catalog_product', true) ) == 'yes' ) ? true : false;
    ?>
...
<div style="padding-left: 3%;height: 60px;" id="place_holder_prod_hide_addtocart_catalog">
    ...
    <?php $place_text =  get_post_meta($post->ID, 'product_adjustment_hide_addtocart_placeholder_catalog',true); ?>
    <textarea name="product_adjustment_hide_addtocart_placeholder_catalog" id="product_adjustment_hide_addtocart_placeholder_catalog" style="width: 40%;"><?php echo $place_text; ?></textarea>
...
<div style="padding-left: 3%;height: 60px;">
    ...
    <?php $checked = (( get_post_meta($post->ID, 'product_adjustment_customize_addtocart_catalog', true) ) == 'yes' ) ? true : false; ?>
...
<div style="padding-left: 3%;height: 60px;" id="btn_text_prod_replace_addtocart_catalog">
    ...
    <?php $place_text =  get_post_meta($post->ID, 'product_adjustment_customize_addtocart_prod_btn_text_catalog',true); ?>
    <input type="text" value="<?php echo $place_text ?>" name="product_adjustment_customize_addtocart_prod_btn_text_catalog" id="product_adjustment_customize_addtocart_prod_btn_text_catalog" style="width: 40%;">
...
<div style="padding-left: 3%;height: 60px;" id="btn_text_shop_replace_addtocart_catalog">
    ...
    <?php $place_text =  get_post_meta($post->ID, 'product_adjustment_customize_addtocart_shop_btn_text_catalog',true); ?>
    <input type="text" value="<?php echo $place_text ?>" name="product_adjustment_customize_addtocart_shop_btn_text_catalog" id="product_adjustment_customize_addtocart_shop_btn_text_catalog" style="width: 40%;">
...
<div style="padding-left: 3%;height: 60px;" id="btn_url_replace_addtocart_catalog">
    ...
    <?php $place_text =  get_post_meta($post->ID, 'product_adjustment_customize_addtocart_btn_url_catalog',true); ?>
    <input type="text" value="<?php echo $place_text ?>" name="product_adjustment_customize_addtocart_btn_url_catalog" id="product_adjustment_customize_addtocart_btn_url_catalog" style="width: 40%;">
...
<div style="padding-left: 3%;height: 60px;">
    ...
    <?php $checked = (( get_post_meta($post->ID, 'product_adjustment_hide_price_catalog', true) ) == 'yes' ) ? true : false; ?>
...
<div style="padding-left: 3%;height: 60px;" id="place_holder_prod_hide_price_catalog">
    <label style="margin-left: 0px;width: 40%;float: left;"><?php _e('Placeholder text', 'elex-catmode-rolebased-price'); ?></label>
    <?php $place_text =  get_post_meta($post->ID, 'product_adjustment_hide_price_placeholder_catalog',true); ?>
    <textarea name="product_adjustment_hide_price_placeholder_catalog" id="product_adjustment_hide_price_placeholder_catalog" style="width: 40%;"><?php echo $place_text; ?></textarea>
...
<div style="padding-left: 3%;height: 60px;">
    <label style="margin-left: 0px;width: 40%;float: left;"><?php _e('Exclude Administrator', 'elex-catmode-rolebased-price'); ?></label>
    <?php $checked = (( get_post_meta($post->ID, 'product_adjustment_exclude_admin_catalog', true) ) == 'yes' ) ? true : false; ?>
    ...
    <label style="float: left;margin-left:5px;"><?php _e('Enable', 'elex-catmode-rolebased-price'); ?></label>
    <span class="description" style="width: 60%;float: right;margin-top: 6px;">
        <?php _e('Check to exclude Administrator role from the above catalog mode settings.', 'elex-catmode-rolebased-price'); ?></span>
</div>
</div>
...
<script type="text/javascript">
    ...
    jQuery(window).on('load', function () {
        ...
        elex_rp_hide_product_placeholder_and_shop_product_checkbox('#product_adjustment_hide_addtocart_catalog','#place_holder_prod_hide_addtocart_catalog','#shop_product_checkbox_prod_hide_addtocart_catalog');
        elex_rp_hide_product_placeholder_text('#product_adjustment_hide_price_catalog','#place_holder_prod_hide_price_catalog');
        elex_rp_customize_addtocart_product_catalog();
        ...
        function elex_rp_customize_addtocart_product_catalog() {
