...
class Support extends Command {
	...
	/**
	 * Get version to print to screen.
	 *
	 * @return string
	 */
	public function getNexcessMappsVersion() {
	...
	public function details() {
		...
		self::section( 'Environment Settings', [
		...
		self::section( 'WordPress Configuration', [
		...
		self::section( 'Cache Configuration', [
	 ...
	 */
	public function getCacheConfiguration( $page_cache_plugins ) {
