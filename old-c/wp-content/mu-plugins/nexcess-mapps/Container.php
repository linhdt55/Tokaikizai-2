...
class Container {
	...
	public function getConfiguration() {
		...
		return array_merge( [
			...
			Commands\Telemetry::class                   => function ( $app ) {
				return new Commands\Telemetry(
					$app->get( Integrations\Telemetry::class )
				);
			},
			...
			Integrations\FeatureFlags::class                  => function ( $app ) {
				return new Integrations\FeatureFlags(
					$app->get( Services\FeatureFlags::class )
				);
			},
			...
			Integrations\Telemetry::class                     => function ( $app ) {
				return new Integrations\Telemetry(
					$app->get( Settings::class ),
					$app->get( Services\Telemetry::class )
				);
			},
			...
			Services\Telemetry::class          => function ( $app ) {
				return new Services\Telemetry(
					$app->get( Settings::class )
				);
			},
